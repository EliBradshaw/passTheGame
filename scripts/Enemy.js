...
export default class {
    constructor(game) {
        ...
        const spawnInPath = player.position.copy().add(player.velocity.copy().normalize().scale(200));
    ...
    update() {
        ...
        let predictedPosition = player.position.copy().add(player.velocity.copy().scale(predictionTime));
